import { classMixin, mergeData, trim, unlinkify, hexToRgb } from "../core/Util";
...
export class TimeMarker {
    ...
    setHeight(h) {
        ...
        if (h <= 56) {
            this._el.content_container.classList.add(
                "tl-timemarker-content-container-small"
            );
        } else {
            this._el.content_container.classList.remove(
                "tl-timemarker-content-container-small"
            );
        }
    ...
    _initLayout() {
        ...
        this._el.timespan = DOM.create(
            "div",
            "tl-timemarker-timespan",
            this._el.container
        );
        this._el.timespan_content = DOM.create(
            "div",
         ...
         */
        // if (this.data.timelineElementColor?.color) {
        //     const bg_color = hexToRgb(this.data.timelineElementColor.color);

        //     const brightness = Math.round(
        //         (parseInt(bg_color.r) * 299 +
        //             parseInt(bg_color.g) * 587 +
        //             parseInt(bg_color.b) * 114) /
        //             1000
        //     );
        //     const textColour = brightness > 125 ? "black" : "white";
        //     this._el.content_container.style.backgroundColor =
        //         this.data.timelineElementColor.color;
        //     this._el.content_container.style.color = textColour;
        // }
        ...
        this._el.line_left = DOM.create(
            "div",
            "tl-timemarker-line-left",
            this._el.timespan
        );
        this._el.line_right = DOM.create(
            "div",
        ...
        // Thumbnail or Icon
        if (this.data.media) {
            this._el.media_container = DOM.create(
                "div",
            ...
            var thumbnail_media_type = this.data.media.thumbnail
                ? lookupMediaType(mtd, true)
                : null;
