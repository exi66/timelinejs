...
export function extend(/*Object*/ dest) /*-> Object*/ {
...
export function ensureUniqueKey(obj, candidate) {
    ...
    for (
        ...
        similar_ids.indexOf(candidate) != -1;
        counter++
    ) {
